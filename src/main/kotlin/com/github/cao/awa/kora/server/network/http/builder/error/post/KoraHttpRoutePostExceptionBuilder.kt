...
class KoraHttpRoutePostExceptionBuilder: KoraHttpRouteExceptionBuilder {
    ...
    inline fun <reified T: Exception, X: Any> targetError(target: KClass<T>, noinline handler: KoraContext.() -> X): KoraHttpRoutePostExceptionBuilder {
        this.routes[target] = handler
        return this
    }

    fun abort(handler: KoraContext.() -> Any): KoraHttpRoutePostExceptionBuilder {
